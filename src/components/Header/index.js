...
export default function header(props){
    ...
    const options = props.home.route.name == 'Island Cars' ? ['Sobre', 'LogOut'] : ['LogOut'];
    const destructiveButtonIndex = props.home.route.name == 'Island Cars' ? 1 : 0;
    ...
    return(
        <View style={styles.container}>
             ...
             <Pressable style={styles.button} onPress={() => showActionSheetWithOptions(
                ...
                buttonIndex => {
                    if (buttonIndex == 0) {
                        props.home.navigation.navigate("Sobre")
                    }

                    if (buttonIndex == 1) {
                        props.home.navigation.navigate("Login")
                    }
                },
            )}>
